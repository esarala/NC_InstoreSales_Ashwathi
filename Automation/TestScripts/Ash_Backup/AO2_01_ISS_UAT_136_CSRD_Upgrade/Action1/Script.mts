...
TestScriptName ="AO2_01_ISS_UAT_136"
...
For i=1 to iRowCount
	...
	If StrComp(CurrentTestCaseName,TestScriptName)=0 Then
		...
		intIMEI2 = DataTable.Value("IMEI2")
		intSSN2 = DataTable.Value("SSN2")
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''Add stock, launch evolution,place order in ePOS''''''''''''''''''''''''''''''''''''''''''''''''''''
...
'Call AccountPage()
'Wait 2
'Call CSRD_desktop_Navigation(stremailID)
'Wait 2
'Call CSRD_Desktop_Upgrade()
'Wait 2
''''''''''''''''''''''''''''''''''''ePOS from CSRD, Initate Upgrade Journey'''''''''''''''''''''''''''''''''''''''''''''''''''
...
Call ProductNavToCreateAccountPage()
wait 2
Call UpgradeselectionIMEIorSSNoreSIM(strJourney,intIMEI,intSSN)
Wait 2
Call ReserveOrder()
Wait 5
Call UpgradeEligibilityCheck()
Wait 5
Call AdvisorSteps()
Wait 5
Call UpgradeDirectDebitDetails(strAccountName,intAccountNumber,intSortCode)
Wait 5
Call UpgradeCreditCheckAndCardDeails(strAccountName,intCardNumber,intCVV)
Wait 5
Call MoreOption()
Wait 5
Call ReviewDetails()
