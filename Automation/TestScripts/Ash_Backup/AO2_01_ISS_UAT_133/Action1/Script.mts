...
TestScriptName = "AO2_01_ISS_UAT_133"
...
If (JavaWindow("Oracle Retail Xstore Point").JavaButton("OK").Exist(2)) Then
	Reporter.ReportEvent micPass, "Attempt to enter cash - Pass","Test Passed"
	Else
...
If (JavaWindow("Oracle Retail Xstore Point").JavaButton("Log Off").Exist(2)) Then
	Reporter.ReportEvent micPass, "Transaction Cancelled","Test Passed"
	Else
	Reporter.ReportEvent micFail, "Transaction not cancelled","Test Failed"
End if
Wait 2
...
'JavaWindow("Oracle Retail Xstore Point").JavaButton("tagname:=Back").Click
'Wait 2
