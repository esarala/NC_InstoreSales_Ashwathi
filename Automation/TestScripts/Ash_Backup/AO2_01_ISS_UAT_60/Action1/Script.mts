...
TestScriptName ="AO2_01_ISS_UAT_60"
'       
...
Wait 2
'---> Sellable ## Call CommonStockAdjustmentSellable(strPLU,strIMEI,LoginType,strXstoreUsername,strXstorePassword)
'Call CommonStockAdjust_Non_Sellable(strPLU,strIMEI,LoginType,strXstoreUsername,strXstorePassword)
Wait 2
...
If Browser("Browser").Page("Page").Frame("ePOSTab&&0Frame").WebElement("It looks like there's").Exist Then
	Reporter.ReportEvent micPass, "No Sellable stock is available - Validation success","Test Passed"
		Else
